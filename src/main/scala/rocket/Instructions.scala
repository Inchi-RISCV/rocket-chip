...
object Instructions {
  ...
  //VCIX zhuzl 20240803
   def IN_VC_X             = BitPat("b0000??1??????????100?????1111011")
   def IN_VC_I             = BitPat("b0000??1??????????011?????1111011")
   def IN_VC_VV            = BitPat("b0010??1??????????000?????1111011")
   def IN_VC_XV            = BitPat("b0010??1??????????100?????1111011")
   def IN_VC_IV            = BitPat("b0010??1??????????011?????1111011")
   def IN_VC_FV            = BitPat("b00101?1??????????101?????1111011")
   def IN_VC_VVV           = BitPat("b1010??1??????????000?????1111011")
   def IN_VC_XVV           = BitPat("b1010??1??????????100?????1111011")
   def IN_VC_IVV           = BitPat("b1010??1??????????011?????1111011")
   def IN_VC_FVV           = BitPat("b10101?1??????????101?????1111011")
   def IN_VC_VVW           = BitPat("b1111??1??????????000?????1111011")
   def IN_VC_XVW           = BitPat("b1111??1??????????100?????1111011")
   def IN_VC_IVW           = BitPat("b1111??1??????????011?????1111011")
   def IN_VC_FVW           = BitPat("b11111?1??????????101?????1111011")
   def IN_VC_V_X           = BitPat("b0000??0??????????100?????1111011")
   def IN_VC_V_I           = BitPat("b0000??0??????????011?????1111011")
   def IN_VC_V_VV          = BitPat("b0010??0??????????000?????1111011")
   def IN_VC_V_XV          = BitPat("b0010??0??????????100?????1111011")
   def IN_VC_V_IV          = BitPat("b0010??0??????????011?????1111011")
   def IN_VC_V_FV          = BitPat("b00101?0??????????101?????1111011")
   def IN_VC_V_VVV         = BitPat("b1010??0??????????000?????1111011")
   def IN_VC_V_XVV         = BitPat("b1010??0??????????100?????1111011")
   def IN_VC_V_IVV         = BitPat("b1010??0??????????011?????1111011")
   def IN_VC_V_FVV         = BitPat("b10101?0??????????101?????1111011")
   def IN_VC_V_VVW         = BitPat("b1111??0??????????000?????1111011")
   def IN_VC_V_XVW         = BitPat("b1111??0??????????100?????1111011")
   def IN_VC_V_IVW         = BitPat("b1111??0??????????011?????1111011")
   def IN_VC_V_FVW         = BitPat("b11111?0??????????101?????1111011")

  //wzw add ROCKET_EXIT for uvmverification
  def ROCKET_EXIT        = BitPat("b00000000000000000000000001101011")
  //添加vector指令编码,jyf 错误：存在重复
  def VL_XE8             = BitPat("b????00???????????000?????0000111")
  def VL_XE16            = BitPat("b????00???????????101?????0000111")
  def VL_XE32            = BitPat("b????00???????????110?????0000111")
  def VL_XE64            = BitPat("b????00???????????111?????0000111")
  def VLS_XE8            = BitPat("b????10???????????000?????0000111")
  def VLS_XE16           = BitPat("b????10???????????101?????0000111")
  def VLS_XE32           = BitPat("b????10???????????110?????0000111")
  def VLS_XE64           = BitPat("b????10???????????111?????0000111")
  def VLX_XE8            = BitPat("b?????1???????????000?????0000111")
  def VLX_XE16           = BitPat("b?????1???????????101?????0000111")
  def VLX_XE32           = BitPat("b?????1???????????110?????0000111")
  def VLX_XE64           = BitPat("b?????1???????????111?????0000111")
  def VS_XE8             = BitPat("b????00???????????000?????0100111")
  def VS_XE16            = BitPat("b????00???????????101?????0100111")
  def VS_XE32            = BitPat("b????00???????????110?????0100111")
  def VS_XE64            = BitPat("b????00???????????111?????0100111")
  def VSS_XE8            = BitPat("b????10???????????000?????0100111")
  def VSS_XE16           = BitPat("b????10???????????101?????0100111")
  def VSS_XE32           = BitPat("b????10???????????110?????0100111")
  def VSS_XE64           = BitPat("b????10???????????111?????0100111")
  def VSX_XE8            = BitPat("b?????1???????????000?????0100111")
  def VSX_XE16           = BitPat("b?????1???????????101?????0100111")
  def VSX_XE32           = BitPat("b?????1???????????110?????0100111")
  def VSX_XE64           = BitPat("b?????1???????????111?????0100111")
  // def VL_X               = BitPat("b????00???????????????????0000111")
  // def VLS_X              = BitPat("b????10???????????????????0000111")
  // def VLX_X              = BitPat("b?????1???????????????????0000111")
  // def VS_X               = BitPat("b????00???????????????????0100111")
  // def VSS_X              = BitPat("b????10???????????????????0100111")
  // def VSX_X              = BitPat("b?????1???????????????????0100111")
  def OPIVV              = BitPat("b?????????????????000?????1010111")
  def OPFVV              = BitPat("b?????????????????001?????1010111")
  def OPMVV              = BitPat("b?????????????????010?????1010111")
  def OPIVI              = BitPat("b?????????????????011?????1010111")
  def OPIVX              = BitPat("b?????????????????100?????1010111")
  def OPFVF              = BitPat("b?????????????????101?????1010111")
  def OPMVX              = BitPat("b?????????????????110?????1010111")
  def VSETVLI            = BitPat("b0????????????????111?????1010111")
  def VSETIVLI           = BitPat("b11???????????????111?????1010111")
  def VSETVL             = BitPat("b10???????????????111?????1010111")
...
//------------------Vector Load/Store instructions--------------------
  ...
  //VFUNARY0
  def VFUNARY0           = BitPat("b010010???????????001?????1010111")
