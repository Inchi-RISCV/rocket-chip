...
class Reduction(implicit p: Parameters) extends VFuModule {
  ...
  vd_sew32 := sum2_sew32 + carry2_sew32
  ...
  vd_sew16 := sum3_sew16 + carry3_sew16
  ...
  compare1_2to1_sew32.io.a := vd0_max_sew32(0)
  compare1_2to1_sew32.io.b := vd0_max_sew32(1)
  compare1_2to1_sew32.io.max := reg_is_max
  compare1_2to1_sew32.io.signed := reg_signed
  ...
  for (i <- 0 until 3) {
    ...
    compare_3to1_sew16.io.max := reg_is_max
    compare_3to1_sew16.io.signed := reg_signed
  ...
  compare1_3to1_sew16.io.signed := reg_signed
  ...
  val in1_max_sew8 = Cat(vd0_max_sew8.reverse)
